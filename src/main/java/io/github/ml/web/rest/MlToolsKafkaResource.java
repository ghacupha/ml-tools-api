...
@RestController
@RequestMapping("/api/ml-tools-kafka")
public class MlToolsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MlToolsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MlToolsKafkaResource(KafkaProperties kafkaProperties) {
