...
public class PoijiOptionsConfig {
    ...
    /**
     * PoijiOptions is a configurations object. As it may appear to wide-eye novice code reviewer that the PoijiOptionsHolder
     * is an instance of over-engineering, but I would sooner ensure that I only have one PoijiOptions in the
     * entire application because engineering for changes in this configuration would be too hard.
