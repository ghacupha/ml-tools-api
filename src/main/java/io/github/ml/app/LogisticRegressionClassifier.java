 ...
 */
public class LogisticRegressionClassifier<L, F> implements Classifier<L, F>, RVFClassifier<L, F> /* Serializable */ {
    ...
    public LogisticRegressionClassifier(double[] weights, Index<F> featureIndex, L[] classes){
    ...
    public LogisticRegressionClassifier(boolean biased) {
        this(new LogPrior(LogPrior.LogPriorType.QUADRATIC), biased);
    }

    @Deprecated //use  in LogisticClassifierFactory instead.
    public LogisticRegressionClassifier(LogPrior prior) {
        this.prior = prior;
    }


    @Deprecated //use  in LogisticClassifierFactory instead
    public LogisticRegressionClassifier(LogPrior prior, boolean biased) {
        this.prior = prior;
        this.biased = biased;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        LogisticRegressionClassifierFactory<String, String> factory = new LogisticRegressionClassifierFactory<>();
        LogisticRegressionClassifier<String, String> lc = factory.trainClassifier(ds, l1reg, 1e-4, biased);
